...
(async () => {
  ...
  // ============ 0. Titelfolie (dunkel) ============
  {
    ...
    s.addText("Florian Schulte, Gießen · Version 2.11.1 · Modell und Skript offen (MIT)", { x: 0.8, y: 6.7, w: 11, h: 0.3, fontFace: FB, fontSize: 11, color: "B8B3A6", isTextBox: true, margin: 0 });
  }
  ...
  // ============ Linkfolie (Seite 11) ============
  {
    ...
    s.addText("Alle Zahlen dieses Vortrags mit Herleitung, Quellen und Interessenlage,\nelf Anhänge und das vollständige Simulationsskript (MIT-Lizenz).",
      { x: 0.6, y: 2.2, w: 6.6, h: 1.2, fontFace: FB, fontSize: 15, color: C.ink, isTextBox: true, margin: 0, valign: "top" });
